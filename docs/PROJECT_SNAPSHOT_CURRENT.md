...
JP Analyzer owns linguistic analysis, immutable analyzer snapshots, Teaching evidence, quality/governance, portability, corpus packaging, evaluation, activation contracts, and tuning handoff contracts.
