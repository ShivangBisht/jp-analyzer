...
def main():
    ...
    original = pipeline.analyze_integrated_alpha2
    try:
        pipeline.analyze_integrated_alpha2 = lambda *args, **kwargs: sentinel
        ...
        pipeline.analyze_integrated_alpha2 = original
    ...
    print("Phase 10.1 stable facade tests passed")
